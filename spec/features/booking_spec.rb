...
feature 'booking a stay' do
  scenario 'a user can select a date to stay in a cloud' do
    ...
    visit('/clouds/:cloud_id/book/new')
    availibility = Availability.create(cloud_id: cloud.id, start_date: "2021-05-05", end_date: "2021-06-05")
    book = Book.create(cloud_id: cloud.id, start_date: "2021-05-23", end_date: "2021-06-05")
